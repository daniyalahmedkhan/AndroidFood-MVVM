...
class ItemIndicator constructor(): RecyclerView.ItemDecoration() {
    ...
    constructor(radius: Int, padding: Int, indicatorHeight: Int, @ColorInt colorInactive: Int, @ColorInt colorActive: Int) : this() {
    ...
    fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val indicatorPosY = parent.height - indicatorHeight / 0.7f
